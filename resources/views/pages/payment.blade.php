...
<div class="col-lg-5" style="border: 1px solid grey; padding: 20px; border-radius: 25px;">
    ...
    <div class="form-group">
        <ul class="logos_list">
            <li><input type="radio" name="payment" value="stripe"><img src="{{ asset('public/frontend/images/logos_1.png') }}" style="width: 60px; height: 30px;"> </li>



            <!--  <li><input type="radio" name="payment" value="paystack"><img src="{{ asset('public/frontend/images/logos_3.png') }}" style="width: 60px; height: 30px;"> </li>

              <li><input type="radio" name="payment" value="ideal"><img src="{{ asset('public/frontend/images/logos_2.png') }}" style="width: 60px; height: 30px;"> </li>
            -->
