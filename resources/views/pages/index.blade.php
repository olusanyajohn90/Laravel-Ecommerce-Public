            ...
            <div class="col-lg-3 col-md-6 char_col">
                ...
                <div class="char_item d-flex flex-row align-items-center justify-content-start">
                    ...
                    <div class="char_content">
                        ...
                        <div class="char_subtitle">from # 50,000</div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="bestsellers_item discount">
                                <div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
                                    ...
                                    <div class="bestsellers_content">
                                        ...
                                        @if($row->discount_price == NULL)
                                        <div class="bestsellers_price discount">${{ $row->selling_price }}<span> </div>
                                              @else
                                        <div class="bestsellers_price discount">${{ $row->discount_price }}<span>${{ $row->selling_price }}</span></div>
                                              @endif


                                                <button id="{{ $row->id }}"  class="btn btn-danger btn-sm" data-toggle="modal" data-target="#cartmodal" onclick="productview(this.id)">Add Now</button>
                                                                </div>
                                                            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="trends_container">
                    ...
                    <div class="trends_text"><p>Buy one Get One Promo.</p></div>
                    ...
                    <div class="owl-carousel owl-theme viewed_slider">
                        ...
                        <div class="owl-item">
                            <div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                <div class="viewed_image"><img src="{{ asset( $row->image_one )}}" alt=""></div>
            ...
            <div class="col">
                <div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
                    ...
                    <div class="newsletter_content clearfix">
                        ...
                        <div class="newsletter_unsubscribe_link" type="submit" ><a href="#">unsubscribe</a></div>
                    </div>
                </div>
            </div>
        </div>
...
<div class="col-md-4">
  ...
  <li class="list-group-item">Stock: <span class="badge" style="background: green;color: white;" > Available</span> </li>
        ...
        <div class="col-md-4">
            <form method="post" action="{{ route('insertintocart') }}">
                @csrf
