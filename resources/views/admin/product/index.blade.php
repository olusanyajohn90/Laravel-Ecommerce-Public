          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                    ...
                    @if ($row->status == 1)
                    <a href="{{URL::to('inactive/product/'.$row->id) }}" class="btn btn-sm btn-danger" ><i class="fa fa-thumbs-down" title="Deactivate"></i></a>
                    @else
                    <a href="{{URL::to('active/product/'.$row->id) }}" class="btn btn-sm btn-info" ><i class="fa fa-thumbs-up" title="Activate"></i></a>
