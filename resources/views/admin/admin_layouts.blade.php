...
<html lang="en">
  <head>
    ...
    <title> Stockify Admin Panel </title>
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> Stokify Admin </a></div>
        ...
        <a href="#" class="sl-menu-link">
          ...
          <ul class="sl-menu-sub nav flex-column">
            ...
            <li class="nav-item"><a href="{{ route('admin.accept.payment') }}" class="nav-link">Accepted Payment </a></li>
             <li class="nav-item"><a href="{{ route('admin.cancel.order') }}" class="nav-link">Canceled Order </a></li>
        ...
        <a href="#" class="sl-menu-link">
          ...
          <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{ route('admin.return.request') }}" class="nav-link">Return Requests</a></li>
             <li class="nav-item"><a href="{{ route('admin.all.return') }}" class="nav-link">All Requests </a></li>
