...
<meta name="description" content="Stockify  project">
...
<!-- chart -->
<link rel="stylesheet" type="text/css" href="{{  asset('public/backend/css/toastr.css')  }}">
<link rel="stylesheet" href="{{ asset('public/frontend/styles/sweetalert2.min.css') }}">
				...
				<div class="row">
                    ...
                    <div class="top_bar_menu">
                     <ul class="standard_dropdown top_bar_dropdown">
                         ...
                         <li>
                   <a href="" data-toggle="modal" data-target="#exampleModal">Track My Order </a>
                         </li>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo_container">
							<div class="logo"><a href="{{ url('/') }}">Stokify</a></div>
						</div>
                    </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is powered with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://yotta.comng" target="_blank">Yotta</a>
