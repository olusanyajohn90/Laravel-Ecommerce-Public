...
class PaymentController extends Controller
{
   ...
   $data['payment'] = $request->payment;
    ...
    return view('pages.payment.stripe',compact('data'));
        ...
        return view('pages.payment.paystack',compact('data'));
  ...
  public function StripeCharge(Request $request){
		...
		\Stripe\Stripe::setApiKey('sk_test_51HHISULAc12yPhxj99iduhvdJLwHsnSUtSTBnKJAnQ9PzAxEUXG8RxhtzYts8WIDysg0Ns04MarRyPd1e8QOfcQX009JF4PRjP');
