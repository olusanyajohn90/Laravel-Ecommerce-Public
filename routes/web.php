...
Route::post('admin/sub/store/category', 'Admin\Category\SubCategoryController@storesubcat')->name('store.subcategory' ) ;
...
Route::get('delete/sub/{id}', 'Admin\Category\CouponController@deletenewsub') ;

// To show Sub Categories with ajax
...
Route::post('insert/into/cart/', 'CartController@insertCart')->name('insertintocart');

Route::get('user/checkout/', 'CartController@Checkout')->name('user.checkout');
Route::get('user/wishlist/', 'CartController@wishlist')->name('user.wishlist');

Route::post('user/apply/coupon/', 'CartController@Coupon')->name('applycoupon');
...
//Route::match(['GET', 'POST'],'/pay', 'PaymentController@redirectToGateway')->name('pay');
...
Route::post('/receivepayment', 'PaymentController@webhook')->name('webhook');
...
Route::get('contact/page', 'ContactUsController@Contact')->name('contact.page');
Route::post('contact/form', 'ContactUsController@ContactForm')->name('contact.form');

Route::get('admin/all/message', 'ContactUsController@AllMessage')->name('all.message');

Route::get('admin/view/message/{id}', 'Admin\OrderController@ViewMessage');
...
Route::get('view/order/{id}', 'FrontController@ViewOrder')->name('order.view');
